let cust = [['A101', '김삿갓', '111-111-1111', true, 0, 1000000], 
			['A102', '정선달', '111-111-2222', false, 0, 500000],
			['A103', '윤나라', '111-111-3333', false, 0, 300000]]

function regist(frm) {
	const element = [frm.cNo.value, frm.cName.value, frm.cNumber.value, frm.yesNo.checked, 0, Number(frm.cLimit.value)]
	cust.push(element)
	console.log(cust)
}
function inStock(frm) {
	var num = frm.cNo.value
